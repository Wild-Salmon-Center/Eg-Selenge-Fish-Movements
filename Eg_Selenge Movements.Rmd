...
# Load river network
river_network <- line2network(path ="Spatial", layer ="FlowNetwork_Final")

# Confirm river network looks accurate
plot(river_network)

# Show network segments
showends(seg=1, rivers=river_network)
showends(seg=2, rivers=river_network)

# Define start of river network
riv <- setmouth(seg=1,vert=22362,rivers=river_network)
plot(riv)
...
```{r Taimen Max displacement plot}
