...
species_colors <- c("darkorange", "darkblue", "darkred", "darkgreen","burlywood4")
...
#  guides(fill = guide_legend(override.aes = list(fill = NA))) +
  ...
  geom_text(aes(label = numb_geolocations$count, color = species), 
            ...
            fontface = "bold",
            size = 4) +
 scale_color_manual(values = c("Taimen" = "darkgreen", "Pike" = "darkred", "White Fish" = "burlywood4", "Lenok" = "darkorange", "Perch" = "darkblue")) +
...
ggsave(filename = "Plots/AllFish_MaxDisplacement_Plot_VER3.png", height = 6, width = 12)
