...
max_distance_df <- data.frame(id = character(), max_river_distance_km = numeric(), stringsAsFactors = FALSE)
...
for (i in id_vec) {
  ...
  max_distance_df <- rbind(max_distance_df, new_row) # Append to results table
